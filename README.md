...
레벨에 존재하는 모든 액터와 구성요소를 볼 수 있다. (screem참조)
-시뮬레이션, 액터이동, 환경등 모든 것을 볼 수 있다.

##액터

언리얼 엔진 내에 존재하는 모든 오브젝트(캐릭터,조명,카메라,사운드등등)
그중 폰은 플레이어나 AI가 조종할 수 있는 오브젝트
콘텐츠 브라우저에서 에셋을 꺼내 배치 가능
